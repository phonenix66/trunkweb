define("modules/security/aqrz/jlaqrz/aqrz_jlaq", ["jquery", "underscore", "page/tools",
    "bootstrap-datepicker", "serializeJSON", "bootstrap-treeview", "jstree"
], function($, _, tools) {
    var page = function() {};
    page = {
        init: function(request) {
            var resourceUrl = `${tools.API_URL}/aqgl/aqrzJlaq`; //页面url地址
            ...
            $('.row-body').on('click', '.zdy-btn-show', function() {
                ...
                tools.toDialog({
                    name: "查看特种作业人员信息",
                    url: "modules/security/aqrz/jlaqrz/aqrz_jlaq_audit.html",
                    param: {
                        edit: data
                    },
                    btn: ['关闭'],
            ...
            $('.row-body').on('click', '.zdy-btn-edit', function() {
                ...
                tools.toDialog({
                    name: "修改安全日志",
                    url: "modules/aqgl/aqrz/aqrz_jlaq_add.html",
                    param: {
                        edit: data
                    },
                    btn: ['保存', '关闭'],
            ...
            $('.row-body').on('click', '.zdy-btn-delete', function() {
                ...
                layer.confirm(
                    ...
                    function(index, layero) {
                        $.ajax({
                            url: `${tools.API_URL}/aqgl/aqrzJlaq/deleteAll`,
                            type: 'get',
                            data: data,
            ...
            function addNewUser() {
                tools.toDialog({
                    name: "添加安全日志",
                    url: "modules/security/aqrz/jlaqrz/aqrz_jlaq_add.html",
                    param: {
                        add: true
                    },
                    skin: "layerui-layer",

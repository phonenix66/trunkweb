 ...
 * 站点管理=》站点维护=》站点维护
 */
define("modules/document/gcgf/gcgf", ["jquery", "underscore", "page/tools","bootstrap-table","bootstrap-table-x-editable","bootstrap-datepicker","bootstrap-table-editable"], function($, _, tools) {
		...
		init: function(request) {
			...
			$('#elyMang').bootstrapTable({
				...
				queryParams: function (params) { //请求服务器发送的参数
					var searchParam = {dictTypeId:'102'};
			...
			$("#elyMangDiv").on("click",".startWorking-edit",function(){
				...
				tools.toDialog({
					name: "修改规程规范资料",
					url: "modules/document/gcgf/gcgf_add.html",
					btn: ['关闭'],
					param : row,

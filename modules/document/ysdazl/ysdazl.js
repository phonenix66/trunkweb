 ...
 * 站点管理=》站点维护=》站点维护
 */
define("modules/document/ysdazl/ysdazl", ["jquery", "underscore", "page/tools","bootstrap-table","bootstrap-table-x-editable","bootstrap-datepicker","bootstrap-table-editable"], function($, _, tools) {
	...
	page = {
		init: function(request) {
			...
			$('#elyMang').bootstrapTable({
				url: tools.API_URL+"/dw/zlgl/getYsdazl",
				toolbar: '', //工具按钮用哪个容器
				...
				queryParams: function (params) { //请求服务器发送的参数
					var searchParam = {dictTypeId:'104',projectId:projectId};
			...
			$("#elyMangDiv").on("click",".startWorking-edit",function(){
				...
				tools.toDialog({
					name: "修改验收必备资料",
					url: "modules/document/ysdazl/ysdazl_add.html",
					btn: ['关闭'],
					param : row,
